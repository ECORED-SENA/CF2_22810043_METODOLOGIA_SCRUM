...
.curso-main-container.pb-3
  ...
  .container.bg-white.container-top.p-4.p-md-5
    ...
    .row.justify-content-center.align-items-center.mb-4
      .col-12.col-lg-10
        ...
        p.mb-3 Profundice en las generalidades y aspectos constitutivos de la programación XP; preste atención al recurso que se muestra a continuación:
  ...
  .container.bg-white.p-4.p-md-5.fondo-1.mg-top
    ...
    p.mb-3.text-center Familiarícese con los siguientes valores del método XP y sus aspectos característicos; procure llevar registro de lo más destacado en su libreta personal de apuntes:
    ...
    .row.justify-content-center.align-items-center.mt-5.mb-5
      .col-lg-10
        ImagenInfografica.color-secundario.mb-3
          ...
          .tarjeta.color-infografica.p-3(x="5%" y="42%"  numero="+" )
          ...
          .tarjeta.color-infografica.p-3(x="37%" y="61%"  numero="+" )
            .row.justify-content-center.mb-3  
              .col-8
                h3 Simplicidad:
          ...
          .tarjeta.color-infografica.p-3(x="55%" y="38%"  numero="+")
            .row.justify-content-center.mb-3  
              .col-8
                h3 Feedback:  
          ...
          .tarjeta.color-infografica.p-3(x="64%" y="62%" numero="+" )
            .row.justify-content-center.mb-3      
              .col-8
                h3 Coraje:
          ...
          .tarjeta.color-infografica.p-3(x="85%" y="42%" numero="+" )
            .row.justify-content-center.mb-3      
              .col-8
                h3 Respeto:
  ...
  .container.bg-white.p-4.p-md-5.container-bottom.mg-top
    ...
    p.mb-5 Los principios más destacados y enfocados al desarrollo de software en el marco de la programación XP son:
  .container.bg-white.p-4.p-md-5.fondo-1.mg-top
    .row.justify-content-center.align-items-center.mb-5
      .col-lg-10
        img(src="@/assets/curso/images/tema3/img_4.svg")
  .container.bg-white.p-4.p-md-5.container-bottom

    Separador 

    #t_3_3.titulo-segundo
      .h4 3.3 Las prácticas XP

    .row.justify-content-center.align-items-center.mb-5
      .col-12.col-lg-7
        p.mb-3.aling-5 Para lograr concretar los valores y llevarlos a la práctica es necesario relacionarlos con algunos principios útiles para el desarrollo. Al igual que los valores, los principios pueden ser muchos según la organización, el tipo de desarrollo o producto, etc.; los principios pueden ser establecidos dependiendo del sistema de software de la empresa.

        p.aling-5.mb-0 Los principios más destacados y enfocados al desarrollo de software en el marco de la programación XP son:
          ...
          .tarjeta-flip__contenedor
            .tarjeta-flip__img.bgr_2.align-items-center
              figure.justify-center
                img.img250.p-2(src='@/assets/curso/images/tema3/ico_1.svg', alt='imagen 1-2')
                h3.text-center Primarias
            .tarjeta-flip__contenido.bgr_3.p-4.p-xl-5
              h3.text-center.text-white Primarias
              p.text-center.text-white.mt-3 Las prácticas primarias se realizan de manera independiente y aportan valor inmediato al producto, ayudan a mejorar el desarrollo del <i>software.</i>
      ...
      .col-sm-6.col-xl-3.mb-4.mb-xl-0
        .tarjeta.tarjeta-flip(@mouseover="indicadorTarjetaFlip = false")
          ...
          .tarjeta-flip__contenedor
            .tarjeta-flip__img.bgr_2.align-items-center
              figure.justify-center
                img.img250.p-2(src='@/assets/curso/images/tema3/ico_2.svg', alt='imagen 1-2')
                h3.text-center Corolario
            .tarjeta-flip__contenido.bgr_3.p-4.p-xl-5
              h3.text-center.text-white  Corolario
              p.text-center.text-white.mt-5 Para las prácticas corolario es necesario tener experiencia en la aplicación de las prácticas primarias. 
        ...
        .tarjeta.tarjeta-flip(@mouseover="indicadorTarjetaFlip = false")
          ...
          .tarjeta-flip__contenedor
            ...
            .tarjeta-flip__contenido.bgr_3.p-4.p-xl-5
              ...
              p.text-center.text-white.mt-5 Las prácticas corolario se deben realizar cuando las primarias ya han sido incorporadas al trabajo
          ...
          .tarjeta-flip__contenedor
            .tarjeta-flip__img.bgr_2.align-items-center
              figure.justify-center
                ...
                h3.text-center Excepcionalidades de la prácticas
            .tarjeta-flip__contenido.bgr_3.p-4.p-xl-5
              h3.text-center.text-white Excepcionalidades de la prácticas
              p.text-center.text-white.mt-5 Una de las prácticas corolario propone reducir los integrantes del equipo, práctica peligrosa si no se respeta el rimo del equipo.
    .titulo-sexto.acento-contenido.mb-5
      h5 Tabla 1.
      span Prácticas primarias y corolario del método programación extrema XP
      ...
      .col-lg-10
        .tabla-a.color-acento-contenido
          table
            thead
              tr.cell--blue
                th(colspan='2') Prácticas XP 
                
            tbody
              tr.cell--blue-1
                td.text-center #[strong Prácticas primarias]
                td.text-center #[strong Prácticas corolario]            
              tr
                td Historias
                td Participación real de clientes
                
              tr
                td Ciclos semanales
                td Despliegue incremental
                
              tr
                td Revisiones y planificaciones
                td Negociar el alcance del contrato
                
              tr
                td Holgura
                td Pagar por funcionalidad
                
              tr
                td Sentarse juntos 
                td  Continuidad de los equipos
    ...
    ModalA(:abrir-modal.sync="modal1")
      .row.align-items-center
        .col-md-6.mb-4.mb-md-0
          ...
          p <i>Scrum</i> es el método que relacionas las mejores prácticas para la gestión del trabajo, y XP, relaciona buenas prácticas de programación, por lo tanto, ambos métodos se complementan, si así se decide trabajar.
