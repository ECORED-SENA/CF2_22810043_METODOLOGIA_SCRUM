...
.curso-main-container.pb-3
    ...
    .row.justify-content-center.align-items-center.mt-5.mb-5
      .col-lg-10(data-aos="fade-down")
        ImagenInfografica.color-secundario.mb-3
          ...
          .tarjeta.color-infografica-1.p-3(x="5%" y="42%"  numero="+" )
          ...
          .tarjeta.color-infografica-1.p-3(x="37%" y="61%"  numero="+" )
            .row.justify-content-center.mb-3  
              .col-8
                h3 Simplicidad:
          ...
          .tarjeta.color-infografica-1.p-3(x="55%" y="38%"  numero="+")
            .row.justify-content-center.mb-3  
              .col-8
                h3 Feedback:  
          ...
          .tarjeta.color-infografica-1.p-3(x="64%" y="62%" numero="+" )
            .row.justify-content-center.mb-3      
              .col-8
                h3 Coraje:
          ...
          .tarjeta.color-infografica-1.p-3(x="85%" y="42%" numero="+" )
            .row.justify-content-center.mb-3      
              .col-8
                h3 Respeto:
  ...
  .container.bg-white.p-4.p-md-5.container-bottom
    ...
    .row.justify-content-center.mb-5
          ...
          .tarjeta-flip__contenedor
            .tarjeta-flip__img.bgr_2.align-items-center
              figure.justify-center
                img.img250.p-2(src='@/assets/curso/images/tema3/ico_1.svg', alt='imagen 1-2').ms-4
                h3 Primarias
      ...
      .col-sm-6.col-xl-3.mb-4-xl-0(data-aos="fade-down")
        .tarjeta.tarjeta-flip(@mouseover="indicadorTarjetaFlip = false")
          .indicador--hover(v-if="indicadorTarjetaFlip")
          .tarjeta-flip__contenedor
            .tarjeta-flip__img.bgr_2.align-items-center
    ...
    .row.justify-content-center.align-items-center
      .col-lg-10
        p.mb-5 La siguiente tabla enuncia las prácticas XP más usadas, analice la información que allí se presenta y afiance su comprensión sobre este punto:
