export default {
  global: {
    ...
    descripcionCurso:
      'Con el estudio de este componente el aprendiz estará en capacidad de aplicar procesos de planeación, ejecución y desarrollos ágiles en el marco de proyectos de desarrollo de <i> software. </i> Afianzará sus conocimientos y habilidades en actividades <i> Scrum, </i> métodos ágiles, programación extrema, método <i> Kanban, </i> entre otras metodologías y enfoques, que buscan responder a requisitos y soluciones siempre cambiantes.',
